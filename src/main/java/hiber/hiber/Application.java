...
import hiber.hiber.controller.SchedulerController;
...
public class Application {
	...
	static PaymentTransactionService transactionService = new PaymentTransactionService();
...
//        users.put("bob.johnson@example.com",
//                new User(2, "Bob Johnson", "bob.johnson", "bob1", "9926745386", "bob.johnson@example.com", 0));
...
//        Bank bankDetails = new Bank(0, bankName, ifscCode, accountNumber, null, null, balance, user);
//        Integer userId, String name, String username, String password, String phoneNumber, String email, Integer role
        User user = new User(10, name, name, password, phone, email, 0);
//        user.setBankDetails(bankDetails);
	...
	//        Bank(int bankId, String bankName, String ifsc, String accountNumber, String upiId, String accountType, double balance, User userObj)
	        ...
	        Bank bankDetails = new Bank(10, bankName, ifscCode, accountNumber, upiId, accountType, 10000, user);
