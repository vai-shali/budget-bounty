...
/**
 * Represents a bank entity with details such as bank ID, name, IFSC code,
 * account number, UPI ID, account type, balance, and the associated user.
 * This entity is mapped to the 'bank' table in the database.
 *
 * @author Inas
...
public class Bank {
     ...
     */
    public Bank(int bankId, String bankName, String ifsc, String accountNumber, String upiId, String accountType,
                double balance, User userObj) {
        this.bankId = bankId;
