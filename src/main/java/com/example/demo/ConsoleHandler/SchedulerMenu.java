...
/**
 * Interacts with the Scheduler Service to manage scheduled payments via console commands.
 * @author Vaishali
...
public class SchedulerMenu {
    ...
    @Autowired
    public SchedulerMenu(SchedulerService schedulerService) {
    ...
    public void handleUserInput(User user) {
        while (true) {
            ...
            switch (choice) {
                case 1:
                    viewScheduledPaymentsByUser(user);
                    break;
                case 2:
                    viewScheduledPaymentsByBillName(user);
                    break;
                case 3:
                    addScheduler(user);
                    break;
                case 4:
                    updateScheduler(user);
                    break;
                case 5:
                    deleteScheduler(user);
                    break;
                case 6:
     ...
     * @return null
     */
    private void viewScheduledPaymentsByUser(User user) {
     ...
     * @return void
     */
    private void viewScheduledPaymentsByBillName(User user) {
     ...
     * @return void
     */
    private void addScheduler(User user) {
        String billType;
     ...
     * @return null
     */
    private void updateScheduler(User user) {
     ...
     * @return void
     */
    private void deleteScheduler(User user) {
        System.out.print("Enter bill name: ");
        String billName = scanner.nextLine();
